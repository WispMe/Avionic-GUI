...
namespace qw
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(qw.control.Resource1.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(qw.control.Resource1.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(qw.control.Resource1.Maquette_Avion);
