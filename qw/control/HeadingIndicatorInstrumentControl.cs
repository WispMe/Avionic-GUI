...
namespace qw
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(qw.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(qw.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(qw.control.Resource1.HeadingIndicator_Aircraft);        
