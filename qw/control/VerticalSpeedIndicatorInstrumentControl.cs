...
namespace qw
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(qw.control.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(qw.control.Resource1.VerticalSpeedNeedle);
