...
namespace qw
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(qw.control.Resource1.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(qw.control.Resource1.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(qw.control.Resource1.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(qw.control.Resource1.Bandeau_Dérouleur);
