...
namespace qw
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(qw.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(qw.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(qw.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(qw.control.Resource1.TurnCoordinatorMarks);
